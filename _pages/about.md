...
**Track 1 — Java & Enterprise Architecture (Primary)**  
Senior Java Developer & Platform Architect with proven experience at banking and enterprise clients (Deutsche Bank, HSBC, Cognizant). Core strengths include **Java, Spring Boot, microservices, FIX/FIXML integration, Apache Spark, Kafka, cloud migrations, and Kubernetes/OpenShift**. I design scalable, resilient systems for high-throughput, low-latency environments and lead architecture governance and modernization efforts.

**Track 2 — AI/ML & Generative AI (Collaborative Contribution)**  
For the past 5 years I’ve actively collaborated with AI/ML teams to deliver practical solutions in **predictive maintenance, IT automation, structured data transformation, and generative AI**. Tools & frameworks I’ve worked with: **TensorFlow, PyTorch, Hugging Face, LangChain, OpenAI APIs, CoreML**. I focus on bridging enterprise systems and ML teams so models are production-ready, scalable, and maintainable.
